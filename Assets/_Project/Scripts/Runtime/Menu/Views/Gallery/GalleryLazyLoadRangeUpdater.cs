...
public sealed class GalleryLazyLoadRangeUpdater
{
    ...
    public GalleryLazyLoadRangeUpdater(GridVisibleRangeCalculator visibleRangeCalculator, 
        MenuScreenConfigAsset configAsset, RectTransform viewport, RectTransform content, 
        GridLayoutGroup gridLayoutGroup, Func<int> getTotalItemsCount, 
    ...
    public void UpdateIfNeeded()
    {
        ...
        if (_lastRange.IsValid && _lastRange.StartIndex == range.StartIndex && _lastRange.EndIndex == range.EndIndex)
        {
            return;
        }
